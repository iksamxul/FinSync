    ...
    <div className="min-h-screen bg-black text-white">
      <div className="grid lg:grid-cols-[280px_1fr]">
        ...
        <main className="p-6">
          ...
          <Card className="mt-6 bg-black border-4 border-dotted border-gray-600 p-6">
            <div className="mb-4 flex border-dotted border-gray-800 text-white items-center justify-between">
